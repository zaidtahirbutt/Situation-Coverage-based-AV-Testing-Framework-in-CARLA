...
class AutonomousAgent(object):
    ...
    def __init__(self, path_to_conf_file):
        ...
        self._global_plan = None  # I guess we will make this in the case of only sensors as well, using GPS and all. Zz
        ...
        self.setup(path_to_conf_file)  # go for it
    ...
    def set_global_plan(self, global_plan_gps, global_plan_world_coord):  # config.agent.set_global_plan(gps_route, self.route)
        """
        Set the plan (route) for the agent
        """

        ds_ids = downsample_route(global_plan_world_coord, 1)  # return ids_to_sample  # although we already sampled with a distance of 1
