...
class OppositeVehicleRunningRedLight(BasicScenario):
    ...
    def _create_behavior(self):
        ...
        """
        crossing_point_dynamic = get_crossing_point(self.ego_vehicles[0])  #this is considered target_location input to InTriggerDistanceToLocation below 

        '''
        return crossing = carla.Location(x=wp_cross.transform.location.x,
        ...
        continue_driving_timeout = TimeOut(10)  # returns success

        continue_driving.add_child(continue_driving_waypoints)  #heaviest func
        ...
        sequence.add_child(continue_driving)  # heavy
