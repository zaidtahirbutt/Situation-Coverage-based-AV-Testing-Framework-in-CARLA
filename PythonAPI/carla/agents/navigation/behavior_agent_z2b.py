...
class BehaviorAgentZ2(Agent):
    ...
    def run_step(self, debug=False):
        ...
        if True: 
            control = self._local_planner.run_step(
                target_speed= min(self.behavior.max_speed-8, self.speed_limit - self.behavior.speed_lim_dist), debug=debug)
        
            # We are using cautious behavior and Cautious max speed is 40 
            # I have hard coded the speed limit to be 100 in this script
